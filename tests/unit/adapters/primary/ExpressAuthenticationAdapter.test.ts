...
describe("ExpressAuthenticationAdapter", () => {
  let adapter: ExpressAuthenticationAdapter;
  ...
  beforeEach(() => {
    ...
    adapter = new ExpressAuthenticationAdapter(mockAuthenticationService);
  });
  ...
  describe("requireAuth middleware", () => {
    ...
    it("should allow authenticated users", () => {
      ...
      adapter.requireAuth(mockReq as Request, mockRes as Response, mockNext);
  ...
  describe("getCurrentUser middleware", () => {
    ...
    it("should pass through for authenticated users", () => {
      ...
      adapter.getCurrentUser(mockReq as Request, mockRes as Response, mockNext);

      expect(mockNext).toHaveBeenCalled();
    });

    it("should pass through for unauthenticated users", () => {
      mockReq.isAuthenticated.mockReturnValue(false);
